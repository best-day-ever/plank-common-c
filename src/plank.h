...
#define PLANK_CLIPBOARD_WIRE_MAGIC 0x504c4342U
#define PLANK_CLIPBOARD_WIRE_VERSION 1U
#define PLANK_CLIPBOARD_MAX_TEXT_SIZE (1024U * 1024U)
#define PLANK_CLIPBOARD_MAX_EVENT_CHUNK_SIZE (48U * 1024U)
#define PLANK_CLIPBOARD_MAX_INPUT_CHUNK_SIZE 8160U
#define PLANK_CLIPBOARD_FLAG_FIRST_CHUNK 0x00000001U
#define PLANK_CLIPBOARD_FLAG_LAST_CHUNK 0x00000002U

typedef struct _PLANK_CLIPBOARD_WIRE_HEADER {
    uint32_t magic;
    uint16_t version;
    uint16_t reserved;
    uint32_t flags;
    ...
    uint32_t chunkOffset;
    uint32_t chunkSize;
} PLANK_CLIPBOARD_WIRE_HEADER, *PPLANK_CLIPBOARD_WIRE_HEADER;
